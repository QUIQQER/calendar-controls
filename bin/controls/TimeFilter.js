/**
 * @module package/quiqqer/calendar-controls/bin/controls/TimeFilter
 ...
 */
define('package/quiqqer/calendar-controls/bin/controls/TimeFilter', [

    'qui/QUI',
    'qui/controls/Control',
    'qui/controls/buttons/Button',
    'qui/controls/buttons/Select',
    'package/quiqqer/calendar-controls/bin/controls/YearFilter',
    'Locale',

    'css!package/quiqqer/calendar-controls/bin/controls/TimeFilter.css'

], function (QUI, QUIControl, QUIButton, QUISelect, YearFilter, QUILocale) {
    "use strict";

    var lg = 'quiqqer/calendar-controls';

    return new Class({

        Extends: QUIControl,
        Type   : 'package/quiqqer/calendar-controls/bin/controls/TimeFilter',
        ...
        create: function () {
            ...
            this.$Select.appendChild(QUILocale.get(lg, 'timeFilter.month'), 'month');
            this.$Select.appendChild(QUILocale.get(lg, 'timeFilter.quarter'), 'quarter');
            this.$Select.appendChild(QUILocale.get(lg, 'timeFilter.halfYear'), 'half-year');
            this.$Select.appendChild(QUILocale.get(lg, 'timeFilter.year'), 'year');
            this.$Select.appendChild(QUILocale.get(lg, 'timeFilter.period'), 'period');
        ...
        refresh: function () {
            ...
            switch (this.$Select.getValue()) {
                ...
                case 'period':
                    ...
                    text = QUILocale.get(lg, 'timeFilter.period.select', {
                ...
                Scheduler.loadExtension('minical').then(function () {
                    ...
                    var Left = new Element('div', {
                        ...
                        html   : '<span class="timefilter-period-select-calendarContainer-year">' +
                            QUILocale.get(lg, 'timeFilter.change.year') +
                            '</span>'
                    }).inject(Container);
